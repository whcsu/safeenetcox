...
setwd("C:/Users/ThinkPad/Desktop/Safe rules/data")

data<-read.csv("Veer2002.csv")
data<-data[,-1]
data<-data[which(data[,2]!='NA'),]
data<-data[order(data$datatemp.Y),]
Y<-data[,1:2]
